        ...
        <form>
          <div :class="{on:isLoginType}">
            <section class="login_message">
              ...
              <button :disabled="!isRightPhone ||sendTime >0 " class="get_verification" :class="{right_phone_number:isRightPhone}" 
                @click.prevent="sendCode">{{sendTime > 0 ?`已发送验证码(${sendTime}s)`:'获取验证码'}}</button>
            </section>
